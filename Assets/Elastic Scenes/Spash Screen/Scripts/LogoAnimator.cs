...
{
    [SerializeField]
    private List<CanvasGroup> SplashScreenDisplayGroup;

    [SerializeField]
    private float SecondsPerLogo = 1f;
    
    [SerializeField]
    private AnimationCurve FadeInCurve = AnimationCurve.EaseInOut(0f, 0f, 0.5f, 1f);
    [SerializeField]
    private AnimationCurve FadeOutCurve = AnimationCurve.EaseInOut(0f, 1f, 0.5f, 0f);

    [SerializeField]
    public UnityEvent OnSplashScreensShown;
