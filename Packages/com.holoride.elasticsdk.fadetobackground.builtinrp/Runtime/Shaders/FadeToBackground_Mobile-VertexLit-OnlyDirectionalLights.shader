...
Shader "FadeToBackground/Mobile|VertexLit (Only Directional Lights)" {
    Properties {
    ...
    Pass {
        ...
        fixed4 frag_surf (v2f_surf IN) : SV_Target
        {
            ...
            half fade = _FadeToBackground_Opacity * clamp((_FadeToBackground_TransparentDistanceSquared - dot(IN.viewPosXZ, IN.viewPosXZ)) / (_FadeToBackground_TransparentDistanceSquared - _FadeToBackground_OpaqueDistanceSquared), 0.0, 1.0);
            c *= fade;
            return c;
        }
